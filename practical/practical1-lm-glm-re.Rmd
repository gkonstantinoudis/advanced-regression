...
load("E:/Postdoc Imperial/Lectures/2023_AdvancedRegression/AdvancedRegression2022-2023/data/exam.London")
dim(exam)
par(mfrow=c(1,2))
...
```{r message=FALSE, warning=FALSE}
titanic = read.csv("E:/Postdoc Imperial/Lectures/2023_AdvancedRegression/AdvancedRegression2022-2023/data/titanic.csv")
dim(titanic)
