...
# Get numeric coefficients of the first polynomial
coef1 <- coef(leg4coef[[1]])     # a numeric vector

# If you just want the constant term (intercept):
const1 <- coef1[1]               # numeric scalar

ggplot() +
  geom_hline(yintercept = const1, linewidth = 1) +
  xlim(-1, 1) +
  ylim(-1, 2) +
  theme_bw() +
  ylab("") +
...
ggplot() +
  geom_abline(slope = 1, intercept = 1, col = cols[1], cex = .6, linewidth = 1) +
  geom_hline(yintercept = coef(leg4coef[[1]]), linewidth = 1) +
  xlim(-1, 1) +
  ylim(-1, 2) +
  theme_bw() +
  ylab("") +
...
ggplot() +
  geom_abline(slope = 1, intercept = 1, col = cols[1], cex = .6, linewidth = 1) +
  geom_hline(yintercept = coef(leg4coef[[1]]) , cex = .6, linewidth = 1) +
  xlim(-1, 1) +
  ylim(-1, 2) +
  geom_line(aes(
